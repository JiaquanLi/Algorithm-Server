...
public:
	...
	*/
	virtual void Print( int cfile, int depth ) const = 0;
...
public:
	...
	*/
	...
	virtual void Print( int cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
	void Print( int cfile, int depth, TIXML_STRING* str ) const;
...
public:
	...
	virtual void Print( int cfile, int depth, TIXML_STRING* str ) const;
	virtual void Print( int cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
...
public:
	...
	*/
	bool LoadFile( int, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( int ) const;
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	...
	virtual void Print( int cfile, int depth = 0 ) const;
	// [internal use]
